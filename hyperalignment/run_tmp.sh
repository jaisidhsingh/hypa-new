...
#SBATCH --output=/home/mila/s/sparsha.mishra/projects/hypa-new/Ldim_5.out
#SBATCH --error=/home/mila/s/sparsha.mishra/projects/hypa-new/Ldim_5.err
...
python3 $pyfile --num-workers=8 --image-embed-dim=1024 --batch-size=128 --offset=5 --end=6;
