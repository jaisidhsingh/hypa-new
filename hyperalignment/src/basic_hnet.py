...
def run(args, input_config):
    ...
    # basic hnet samples encoders only once (first 6 384 dim encoders)
    encoder_indices, encoder_dims = next(encoder_loader)
    assert 384 in encoder_dims, "[ERROR]"
...
def main(args):
    ...
    num_encoders_ablation = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment-name", type=str, default="mm_adapt_test")
