...
#SBATCH --output=/home/mila/s/sparsha.mishra/projects/hypa-new/Ldim_9.out
#SBATCH --error=/home/mila/s/sparsha.mishra/projects/hypa-new/Ldim_9.err
...
python3 $pyfile --num-workers=8 --image-embed-dim=1024 --batch-size=128 --offset=9 --end=10;
